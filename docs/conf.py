...
htmlhelp_basename = 'AltWalkerdoc'
...
latex_documents = [
    (master_doc, 'AltWalker.tex', 'AltWalker Documentation',
     'Altom Consulting', 'manual'),
]
...
man_pages = [
    (master_doc, 'altwalker', 'AltWalker Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AltWalker', 'AltWalker Documentation',
     author, 'AltWalker', 'Altwalker is an open source, Model-based testing framework for automating your test execution.',
     'Miscellaneous'),
]
...
# True to parse Google style docstrings. False to disable support for
